...
Use CMake to produce a makefile that compiles the sample `pdftoolsbuiltincertify`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsbuiltincertify <certificateFile> <password> <inputPath> <outputPath>`
