...
Use CMake to produce a makefile that compiles the sample `pdftoolsbuiltinsign`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsbuiltinsign <certificateFile> <password> <inputPath> <outputPath>`
