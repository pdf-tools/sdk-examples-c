...
Use CMake to produce a makefile that compiles the sample `pdftoolsglobalsigndssaddtimestamp`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsglobalsigndssaddtimestamp <inputPath> <outputPath>`
