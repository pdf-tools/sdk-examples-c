...
Use CMake to produce a makefile that compiles the sample `pdftoolsglobalsigndsssign`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsglobalsigndsssign <commonName> <inputPath> <outputPath>`
