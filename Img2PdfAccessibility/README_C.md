...
Use CMake to produce a makefile that compiles the sample `pdftoolsimg2pdfaccessibility`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsimg2pdfaccessibility <inputPath> <alternateText> <outputPath>`
