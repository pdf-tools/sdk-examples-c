...
Use CMake to produce a makefile that compiles the sample `pdftoolsmultipleimg2pdf`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsmultipleimg2pdf <inputPath> [<inputPath2> ...] <outputPath>`
