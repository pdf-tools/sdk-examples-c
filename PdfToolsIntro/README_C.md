...
Use CMake to produce a makefile that compiles the sample `pdftoolspdftoolsintro`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolspdftoolsintro <coverImage> <contentPdfPath> <outputPath>`
