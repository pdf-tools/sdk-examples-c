...
Use CMake to produce a makefile that compiles the sample `pdftoolssignaturesvalidate`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolssignaturesvalidate <inputPath> [<certificateDirectory>]`
