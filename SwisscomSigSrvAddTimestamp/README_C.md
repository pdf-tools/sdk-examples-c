...
Use CMake to produce a makefile that compiles the sample `pdftoolsswisscomsigsrvaddtimestamp`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsswisscomsigsrvaddtimestamp <identity> <inputPath> <outputPath>`
