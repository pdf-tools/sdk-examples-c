...
Use CMake to produce a makefile that compiles the sample `pdftoolsswisscomsigsrvsign`.
...
2. Run: `cmake .`
3. Run: `cmake --build .`
4. Run the sample: `./pdftoolsswisscomsigsrvsign <identity> <commonName> <inputPath> <outputPath>`
