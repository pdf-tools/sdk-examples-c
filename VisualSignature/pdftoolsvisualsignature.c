/****************************************************************************
 *
 * File:            pdftoolsvisualsignature.c
 *
...
int Usage()
{
    printf("Usage: pdftoolsvisualsignature <certificateFile> <password> <appConfigFile> <inputPath> <outputPath>.\n");
    printf("return codes:\n");
...
int _tmain(int argc, TCHAR* argv[])
{
    ...
    int nPageNumber = 1;
    PdfToolsSign_Appearance_SetPageNumber(pAppearance, &nPageNumber);
